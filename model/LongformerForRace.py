...
import torch
from transformers import BertConfig, LongformerForMultipleChoice, AdamW, get_linear_schedule_with_warmup

from data.RACEDataModule import RACEDataModule


class LongformerForRace(pl.LightningModule):
    def __init__(
            self,
        ...
        print(self.config)
        self.model = LongformerForMultipleChoice.from_pretrained(pretrained_model, config=self.config)
