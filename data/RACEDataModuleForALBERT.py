...
class RACEDataModuleForALBERT(pl.LightningDataModule):
    def __init__(
            self,
    ...
    # auto cache tokens
    @staticmethod
    def preprocess(tokenizer: AlbertTokenizerFast, scorer: rouge_scorer, max_seq_length: int, use_sentence_selection: bool,
...
if __name__ == '__main__':
    dm = RACEDataModuleForALBERT(train_batch_size=32)
    dm.setup('train')
